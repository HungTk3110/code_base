...
import 'package:flutter_base/ui/pages/notification/notification_list/notification_list_cubit.dart';
    ...
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider<NotificationRepository>(create: (context) {
          return NotificationRepositoryImpl(apiClient: _apiClient);
        }),
      ],
        ...
        providers: [
          ...
          BlocProvider<NotificationListCubit>(
            create: (context) {
              ...
              return NotificationListCubit(notificationRepository: userRepo);
            },
          )
        ],
